...
const objEscolhaLocal = {
    html: [
        {titulo: "Embaixo da Ponte", cor: "warning", frase:"Gostei da ideia da ponte! Um grande cartão postal para uma grande ideia!"},
        {titulo: "Metrô", cor: "info", frase:"O metrô! Vou prosperar com toda a movimentação do lugar!"},
        {titulo: "Parque Gastronômico", cor: "danger", frase:"Acredito que meu produto combine bem com o local do Parque Gastronomico"},
        {titulo: "Faculdade", cor: "purple", frase:"Perto da faculdade me sinto confortável! Muitos irão vir comer depois das aulas!"}
    ],
    errada: 1,
