...
<span class="marcio">"Bom trabalho, <span id="nome"></span>, me parece que seu negócio está indo muito bem por enquanto!"</span>#
...
<span class="marcio">"Então você se tornou um marqueteiro nato! Pensou no produto, na praça, no preço e na promoção. Esses são os 4 Ps de marketing! E escolheu eles com base nas suas análises, desde você mesmo com a SWOT, até a do ambiente, da concorrência e de mercado-alvo!"</span>#
...
<span class="marcio">"Isso não tira o seu mérito! Mas as coisas não acabam por aí, tem muito mais coisa que você pode pensar para continuar crescendo no futuro. Minha recomendação a partir daqui é definir seus objetivos SMART."</span> #

<span class="player">"Mas o que seria exatamente SMART?"</span>#

<span class="marcio">"A metodologia SMART está relacionada com a definição dos seus objetivos futuros dentro do seus negócio, a fim de deixá-los alinhados ao que é possível realizar com seu negócio e o mercado que o engloba.
...
<span class="marcio">"É só seguir o acrônimo S.M.A.R.T! Ele mostra as características que seus objetivos traçados devem obedecer.</span>#
<span class="marcio">Em inglês temos: S de Specific, que significa ser específicos. M de Measurable, que quer dizer mensuráveis. A de Attainable, que traduz para atingíveis. R de Realistic, que nada mais é que realistas. E finalmente T de Time-bound,o mesmo que ter prazos.</span>#
<span class="marcio">Com isso seus objetivos vão ser mais claros, deixando de ser amplos como "vender mais" e passando a ter prazos, números e rumos bem mais definidos."</span>#
