...
<span class="player">"É mesmo, eu nem tinha percebido isso! Mas eu não teria nem pensado em ir atrás disso tudo se não fosse você."</span>#
...
<span class="balao marcio">"A metodologia SMART está relacionada com a definição dos seus objetivos futuros dentro do seus negócio, a fim de deixá-los alinhados ao que é possível realizar com seu negócio e o mercado que o engloba.
 Basicamente vai deixar seus objetivos dentro de expectativas reais!"</span>#
...
<span class="balao marcio">Com isso seus objetivos serão mais claros, deixando de ser amplos como "vender mais" e passando a ter prazos, números e rumos bem mais definidos."</span>#

<span class="player">"Caramba, que aula você me deu agora! Definitivamente vou por em prática tudo que você me ensinou!"</span>#
...
function concatenaGremio(){
    if(_local.texto=="Faculdade" && _promocao.texto =="Divulgar no Instagram"){
        return "<span class='narrador'>Você conversa com o grêmio da faculdade e vocês acordam em um desconto para os estudantes. Considerando que é um público regular durante todos os dias da semana, isso lhe garante uma estabilidade nas vendas que assegura a manutenção do seu foodtruck.</span>";
    }
    return "";
}
